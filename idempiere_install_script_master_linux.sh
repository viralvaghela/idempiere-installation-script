...
# then
    ...
    #Note: if you already have a downloaded copy of iDempiere's hg repo zip, update the following URL
     $SCRIPTPATH/utils/downloadtestzip.sh "https://master.dl.sourceforge.net/project/idempiere/v9/source-repo/idempiere_gitrepo_v9.zip?viasf=1" idempiere-hg-download.zip $OSUSER_HOME/dev/ || exit 1
